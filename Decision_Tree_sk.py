...
#Phân loại bằng Decision Tree
clf = tree.DecisionTreeClassifier()
# sử dụng X_train làm dữ liệu huấn luyện
...
# result_decisiontree_sk = open("F:/HK4/ML/Case_Study_#1/Source_Code_Titanic_Dataset/result_decisiontree_sk.txt", "a+")
# for i in range (0, len(pre)):
# 	result_decisiontree_sk.write(str(pre[i]) + "\n")
# result_decisiontree_sk.close()
